module "iam_assumable_role" {
  ...
  role_policy_arns = var.enabled_additional_policy ? [aws_iam_policy.secret_manager.arn, aws_iam_policy.additional_policy[0].arn] : [aws_iam_policy.secret_manager.arn]
